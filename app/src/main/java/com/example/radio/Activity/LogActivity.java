...
import com.example.radio.databinding.ActivityLogBinding;
...
public class LogActivity extends AppCompatActivity {
    ...
    ActivityLogBinding loginNewBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginNewBinding = ActivityLogBinding.inflate(getLayoutInflater());
        ...
        loginNewBinding.loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (loginNewBinding.emailtextinputLayout.getEditText().getText().toString().isEmpty()) {
                    ...
                    AlertDialog.Builder builderlog = new AlertDialog.Builder(LogActivity.this);
                                            ...
                                            if (userlogin.equals("0")) {
                                                ...
                                                if (!isReady) {
                                                    ...
                                                    if (em.equals("HR")) {
                                                        ...
                                                        startActivity(new Intent(LogActivity.this, InfoHrActivity.class));
                                                        ...
                                                        if (sd.equals("0")) {
                                                            ...
                                                            startActivity(new Intent(LogActivity.this, DashActivity.class));
                                                            snapshot.getRef().child("userlogin").setValue("1");
                                                            isReady = true;

                                                        } else if (sd.equals("1")) {
                                                            startActivity(new Intent(LogActivity.this, UserAttendenceActivity.class));
                                                            snapshot.getRef().child("userlogin").setValue("1");
                                                            isReady = true;
                                                        }
                                                    }
                                                ...
                                                Toast.makeText(LogActivity.this, "User already logging", Toast.LENGTH_SHORT).show();
                                            }
...
//                                            }
                                    ...
                                    Toast.makeText(LogActivity.this, "please verify Email ", Toast.LENGTH_SHORT).show();
                                }
        ...
        loginNewBinding.textView6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(LogActivity.this);
                            ...
                            auth.sendPasswordResetEmail(editText.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(LogActivity.this, "check your Email", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                    } else {
                                        Toast.makeText(LogActivity.this, "" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }
