...
import com.example.radio.databinding.ActivitySignBinding;
...
public class SignActivity extends AppCompatActivity implements MultiplePermissionsListener {

    ActivitySignBinding activitySignup2Binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activitySignup2Binding = ActivitySignBinding.inflate(getLayoutInflater());
        ...
        activitySignup2Binding.spinner2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(SignActivity.this, R.style.MySpinnerDatePickerStyle, date, myCalendar
        ...
        activitySignup2Binding.editTextTextPersonDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(SignActivity.this, R.style.MySpinnerDatePickerStyle, date1, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH));
        ...
        activitySignup2Binding.floatingactionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dexter.withContext(SignActivity.this)
                        .withPermissions(
            ...
            mAuth.createUserWithEmailAndPassword(company_email, password1).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        AlertDialog.Builder builder3 = new AlertDialog.Builder(SignActivity.this);
...
//                        Log.i("Image url", uri.toString());
                        ...
                        Toast.makeText(SignActivity.this, "user already sigg up   ", Toast.LENGTH_SHORT).show();
                    }
                }
            });
