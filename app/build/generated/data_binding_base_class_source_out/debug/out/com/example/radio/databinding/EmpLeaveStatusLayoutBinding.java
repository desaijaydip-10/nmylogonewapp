...
public final class EmpLeaveStatusLayoutBinding implements ViewBinding {
  ...
  private EmpLeaveStatusLayoutBinding(@NonNull SwipeRevealLayout rootView,
      ...
      @NonNull ImageView checkImagview, @NonNull CardView customCardvide,
      @NonNull TextView declineTextView, @NonNull FrameLayout deleteLayout,
      @NonNull TextView empTextView, @NonNull CircleImageView empprofileImg,
      @NonNull LinearLayout frontLayout, @NonNull ImageView imgcheckvalue,
      @NonNull SwipeRevealLayout swipeLayout) {
  ...
  public static EmpLeaveStatusLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EmpLeaveStatusLayoutBinding((SwipeRevealLayout) rootView, accepttextView,
          cancelImagview, checkImagview, customCardvide, declineTextView, deleteLayout, empTextView,
          empprofileImg, frontLayout, imgcheckvalue, swipeLayout);
    }
