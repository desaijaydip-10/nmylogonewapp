...
public final class ActivityEmpProfileBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityEmpProfileBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView backarrow, @NonNull ConstraintLayout constraintLayout,
      @NonNull ImageView editImg, @NonNull CircleImageView imageView2,
      @NonNull TextView phonenumberTextView, @NonNull TextView punchIntextView,
  ...
  @NonNull
  public static ActivityEmpProfileBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEmpProfileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_emp_profile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEmpProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEmpProfileBinding((ConstraintLayout) rootView, backarrow, constraintLayout,
          editImg, imageView2, phonenumberTextView, punchIntextView, textView10, textView11,
          textView12, textView13, textView14, textView15, textView16, textView17, textView18,
          textView19, textView23, textView24, textView7, textView8, textView9, view10, view11,
          view2, view3, view5, view6, view7);
    }
