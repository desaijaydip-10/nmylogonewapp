...
public final class ActivityHrProfileBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityHrProfileBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backarrow,
      @NonNull ConstraintLayout constraintLayout, @NonNull ImageView editImg,
      @NonNull CircleImageView imageView2, @NonNull ImageView imgview,
      @NonNull TextView punchIntextView, @NonNull TextView textView10, @NonNull TextView textView11,
      ...
      @NonNull TextView textView18, @NonNull TextView textView19, @NonNull TextView textView23,
      ...
      @NonNull View view10, @NonNull View view11, @NonNull View view2, @NonNull View view3,
  ...
  @NonNull
  public static ActivityHrProfileBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityHrProfileBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_hr_profile, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHrProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editImg;
      ImageView editImg = rootView.findViewById(id);
      if (editImg == null) {
        break missingId;
      }
      ...
      return new ActivityHrProfileBinding((ConstraintLayout) rootView, backarrow, constraintLayout,
          editImg, imageView2, imgview, punchIntextView, textView10, textView11, textView12,
          textView13, textView14, textView15, textView16, textView17, textView18, textView19,
          textView23, textView24, textView25, textView6, textView7, textView8, textView9, view10,
          view11, view2, view3, view5, view6, view7);
    }
