...
public final class EmpLeavesLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private EmpLeavesLayoutBinding(@NonNull SwipeRevealLayout rootView,
      ...
      @NonNull CircleImageView profileImg11, @NonNull SwipeRevealLayout swipeLayout,
  ...
  @NonNull
  public static EmpLeavesLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EmpLeavesLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.emp_leaves_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EmpLeavesLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EmpLeavesLayoutBinding((SwipeRevealLayout) rootView, accepttextView,
          cancelImagview, checkImagview, customCardvide, declineTextView, deleteLayout, frontLayout,
          imgcheckvalue, profileImg11, swipeLayout, userTextView);
    }
