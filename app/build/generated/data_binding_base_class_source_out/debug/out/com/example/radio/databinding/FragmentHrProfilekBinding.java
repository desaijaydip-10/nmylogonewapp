...
public final class FragmentHrProfilekBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHrProfilekBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textView9, @NonNull View view10, @NonNull View view11, @NonNull View view2,
      @NonNull View view3, @NonNull View view5, @NonNull View view6, @NonNull View view7) {
  ...
  @NonNull
  public static FragmentHrProfilekBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHrProfilekBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_hr_profilek, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHrProfilekBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHrProfilekBinding((ConstraintLayout) rootView, constraintLayout,
          imageView2, imageView9, imgview, textView10, textView11, textView12, textView13,
          textView14, textView15, textView16, textView17, textView18, textView19, textView20,
          textView23, textView24, textView6, textView7, textView8, textView9, view10, view11, view2,
