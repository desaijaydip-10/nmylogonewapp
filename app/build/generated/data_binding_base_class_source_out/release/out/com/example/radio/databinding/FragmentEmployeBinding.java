...
public final class FragmentEmployeBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentEmployeBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout constraintLayout, @NonNull CircleImageView imageView2,
      @NonNull ImageView imageView9, @NonNull ImageView imgview, @NonNull TextView textView10,
  ...
  @NonNull
  public static FragmentEmployeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentEmployeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_employe, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentEmployeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentEmployeBinding((ConstraintLayout) rootView, constraintLayout, imageView2,
          imageView9, imgview, textView10, textView11, textView12, textView13, textView14,
          textView15, textView16, textView17, textView18, textView19, textView20, textView23,
