...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout container,
      @NonNull ImageView imageView10, @NonNull ImageView imageView11, @NonNull ImageView img,
      @NonNull ConstraintLayout main, @NonNull TextView txtview45) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppBarMainBinding((ConstraintLayout) rootView, container, imageView10, imageView11,
          img, main, txtview45);
    }
