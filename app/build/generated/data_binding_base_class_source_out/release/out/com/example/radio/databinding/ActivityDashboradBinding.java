...
public final class ActivityDashboradBinding implements ViewBinding {
  ...
  private ActivityDashboradBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backArrow,
  ...
  public static ActivityDashboradBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_dashborad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityDashboradBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDashboradBinding((ConstraintLayout) rootView, backArrow, cardview1,
